...
const createEditPointTemplate = (point) => {
  const {type, destination, offers, base_price, date_from, date_to} = point;
  const formattedDateFrom = formatDate(date_from, 'DD/MM/YY HH:mm');
  const formattedDateTo = formatDate(date_to, 'DD/MM/YY HH:mm');
